...
OpenJsCad.parseJsCadScriptASync = function(script, mainParameters, options, callback) {
  var baselibraries = [
    "packages/nitrocad_csg/lib/js/csg.js",
    "packages/nitrocad_core/lib/js/openjscad.js",
    "packages/nitrocad_core/lib/js/openscad.js"
  ...
  workerscript += "var Package = { meteor: {}};\n";                           // Shim for Meteor packages
  workerscript += "var me = " + JSON.stringify(me) + ";\n";
...
OpenJsCad.textToBlobUrl = function(txt) {
  ...
  var blob = new window.Blob([txt], { type : 'application/javascript' });
